{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 12.0, 48.0, 761.0, 483.0 ],
		"bglocked" : 0,
		"defrect" : [ 12.0, 48.0, 761.0, 483.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Note: you don't need to set a @transport. The help files use it so they don't interfere with the global transport, which is the default transport used by these objects.",
					"linecount" : 7,
					"fontname" : "Verdana",
					"patching_rect" : [ 1.0, 258.0, 146.0, 101.0 ],
					"fontsize" : 11.1,
					"numinlets" : 1,
					"numoutlets" : 0,
					"id" : "obj-19"
				...
				"box" : 				{
					...
					"patcher" : 					{
						...
						"boxes" : [ 							{
								"box" : 								{
									"maxclass" : "comment",
									"text" : "BUG ALERT! This currently doesn't work with multiple ajm.metros in Max 5.0.5 due to bugs in the transport system. This should be resolved in the near future.",
									"linecount" : 8,
									"fontname" : "Verdana",
									"patching_rect" : [ 10.0, 59.0, 147.0, 114.0 ],
									"fontsize" : 11.1,
									"numinlets" : 1,
									"presentation_rect" : [ 31.0, 86.0, 0.0, 0.0 ],
									"numoutlets" : 0,
									"id" : "obj-10"
								}
