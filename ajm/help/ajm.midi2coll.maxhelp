...
, 							{
								"box" : 								{
									...
									"fontname" : "Verdana",
									"numinlets" : 1,
									"patching_rect" : [ 121.0, 122.0, 202.0, 47.0 ],
									"fontsize" : 11.1,
									"numoutlets" : 0,
									"id" : "obj-3"
								}
					...
					"patcher" : 					{
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"fontname" : "Verdana",
									"numinlets" : 1,
									"patching_rect" : [ 344.0, 181.0, 115.0, 33.0 ],
									"fontsize" : 11.1,
									"numoutlets" : 0,
									"id" : "obj-9"
								}
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "ajm.relmetro 8n @transport ajm_m2c_ts",
									"fontname" : "Verdana",
									"numinlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "ajm.relmetro, ajm.makenote, coll",
					"fontname" : "Verdana",
					"hidden" : 1,
					"numinlets" : 2,
					"patching_rect" : [ 365.0, 397.0, 201.0, 18.0 ],
					"fontsize" : 11.1,
					"numoutlets" : 1,
					"id" : "obj-73",
					"outlettype" : [ "" ]
