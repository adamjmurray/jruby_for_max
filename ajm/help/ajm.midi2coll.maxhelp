	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"linecount" : 4,
					"fontname" : "Verdana",
					"patching_rect" : [ 355.0, 351.0, 122.0, 55.0 ],
					"hidden" : 1,
					"fontsize" : 10.0,
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"text" : "loadmess 0 0",
					"fontname" : "Verdana",
					"patching_rect" : [ 361.0, 407.0, 85.0, 20.0 ],
					"hidden" : 1,
					"fontsize" : 11.1,
					"numinlets" : 1,
					"numoutlets" : 1,
				...
				"box" : 				{
					...
					"patcher" : 					{
						...
						"boxes" : [ 							{
								"box" : 								{
									"maxclass" : "message",
									"text" : "from ajm.midi2coll",
									"fontname" : "Verdana",
									"patching_rect" : [ 17.0, 20.0, 116.0, 18.0 ],
									"fontsize" : 11.1,
									"numinlets" : 2,
									"numoutlets" : 1,
									"id" : "obj-6",
...
, 			{
				"box" : 				{
					"maxclass" : "bpatcher",
					"patching_rect" : [ 376.0, 244.0, 113.0, 115.0 ],
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-27", 1 ],
					"hidden" : 0,
					"midpoints" : [ 145.0, 430.0, 66.0, 430.0 ]
				}
