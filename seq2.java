...
public class seq2 extends MaxObject {

	public seq2(Atom[] args) {
		declareIO(1, 4);
	...
	*/
	...
	protected enum CHORDMODE {
		CHORD, ARPEGGIATE, SYMBOL;
	}

	// For use in anonymous classes
	protected final seq2 thisseq = this;
	...
	*/
	...
	public void chordmode(String chordmode) {
		if (chordmode != null) {
			...
			else if (chordmode.equals("arpeggiate")) {
	...
	*/
	...
	public boolean equals(Object obj) {
		if (obj instanceof seq2) {
			return Arrays.equals(getvalues(), ((seq2) obj).getvalues());
		}
		else {
			return false;
		}
